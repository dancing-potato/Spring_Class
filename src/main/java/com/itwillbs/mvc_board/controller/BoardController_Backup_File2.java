...
@Controller
public class BoardController_Backup_File2 {
//	@Autowired
...
//		
//		// 복수개의 파일을 하나의 이름으로 묶을 경우
//		String originalFileNames = "", realFileNames = "";
//		
//		// MultipartFile 배열 반복
...
//		}
//		
//		System.out.println("실제 파일 목록 : " + originalFileNames);
//		System.out.println("업로드 될 파일 목록 : " + originalFileNames);
//		
...
//		// ==========================================================
//		// 결합된 문자열 분리 방법
//		String[] oriFileNames = board.getBoard_file().split("/");
//		System.out.println(Arrays.toString(oriFileNames));
//		String[] reFileNames = board.getBoard_real_file().split("/");
//		System.out.println(Arrays.toString(reFileNames));
//				
//		// ==========================================================
//		
////		int insertCount = service.registBoard(board);
